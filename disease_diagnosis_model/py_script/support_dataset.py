...
# dataset class
class dataset():
    def __init__(self, da_tr, folder, bat_num, lab_ind):
        # read data
        self.tr_da, self.va_da, self.te_da, self.lab_na = srd.read_da(da_tr, folder)
    ...
    def get_bat_data(self, ty_str):
        ...
        return img, torch.tensor(lab), da[2][bi], da[3][bi]
